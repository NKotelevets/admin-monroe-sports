...
import EventDeletingInfo from '@/pages/Protected/Events/EventDeletingInfo'
...
import {
  ...
  PATH_TO_EDIT_LEAGUE_TEAM, PATH_TO_CREATE_EVENT, PATH_TO_EDIT_EVENT, PATH_TO_DELETE_INFO_EVENTS
