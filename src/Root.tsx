...
import {
  ...
  PATH_TO_USERS_IMPORT_INFO, PATH_TO_LEAGUE_TEAMS, PATH_TO_CREATE_LEAGUE_TEAM, PATH_TO_MASTER_TEAM_SCHEDULE_REQUEST
...
const Root = () => (
  <AuthProvider>
    ...
    <Routes>
      ...
      <Route path={`${PATH_TO_MASTER_TEAM_SCHEDULE_REQUEST}`} element={<MasterTeamScheduleRequest />} />
