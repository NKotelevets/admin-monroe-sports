...
import { duplicatesErrorMap, duplicatesMap, duplicatesTableMap } from '@/redux/leagueTeams/mappers'
...
import '@/common/interfaces/leagueTeams'
      ...
      .addMatcher(leagueTeamsApi.endpoints.leagueTeamsImportCSV.matchFulfilled, (state, action) => {
        state.createdIds = action.payload.success
          .filter((lt) => {
            ...
            if (lt['League Team Name']) return lt['League Team Name']
