...
export interface IBECreateLeagueBody
  extends Omit<
    IBELeague,
    'id' | 'updated_at' | 'created_at' | 'league_seasons'
  > {
  league_seasons?: string[];
}

export interface IBEUpdateLeagueBody
  extends Omit<IBELeague, 'updated_at' | 'created_at' | 'league_seasons'> {}
