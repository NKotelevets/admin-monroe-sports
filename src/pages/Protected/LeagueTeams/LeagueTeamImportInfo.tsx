 ...
 * - The `LeagueTeamImportTable` component is rendered within the page to display the team import information.
 */
const LeagueTeamImportInfo = (): ReactElement => {
  return (
    <TableProvider>
      <Page
        title="Import Info"
      ...
      >
        <LeagueTeamImportTable />
      </Page>
    </TableProvider>
  )
}

export default LeagueTeamImportInfo
