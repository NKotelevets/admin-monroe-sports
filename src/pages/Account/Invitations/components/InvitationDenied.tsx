...
const InvitationDenied = (props: TInvitationDeniedProps) => {
  ...
  return (
    <Body centered>
      ...
      <Subtitle style={{marginBottom: 32}}>You have successfully rejected the invitation to join {teamName} as {role}. If you change your mind and would like to join this team, please reach out to a Master Team Admin to request a new invitation.</Subtitle>
